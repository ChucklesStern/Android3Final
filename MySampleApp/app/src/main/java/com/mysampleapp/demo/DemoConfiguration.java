...
import com.mysampleapp.inventorydata.inventorymain;
import com.mysampleapp.shoppingcart.MainShopping;
...
public class DemoConfiguration {
    ...
    static {
        ...
        addDemoFeature("shopping_cart", R.mipmap.icon_star,
                R.string.feature_app_shopping_cart_title,
                R.string.feature_app_shopping_cart_subtitle,
                R.string.feature_app_shopping_cart_overview,
                R.string.feature_app_shopping_cart_description,
                R.string.feature_app_shop_cart_powered_by,
                new DemoItem(R.string.main_fragment_title_shopping_cart,
                        R.mipmap.icon_star,
                        R.string.feature_app_shopping_cart_demo_button,
                        MainShopping.class));
        ...
        addDemoFeature("shopping_cart", R.mipmap.icon_star,
                ...
                new DemoItem(R.string.main_fragment_title_shopping_cart,
                        ...
                        R.string.feature_app_shopping_cart_demo_button,
                        inventorymain.class));
        addDemoFeature("inventory", R.mipmap.icon_star,
                R.string.feature_app_inventory_title,
                R.string.feature_app_inventory_subtitle,
                R.string.feature_app_inventory_overview,
                R.string.feature_app_inventory_description,
                R.string.feature_app_shop_cart_powered_by,
                new DemoItem(R.string.main_fragment_title_inventory,
                        R.mipmap.icon_star,
                        R.string.feature_app_inventory_demo_button,
                        inventorymain.class));
